...
/* 
 * Wenn nun der Sensorwert bei normaler Helligkeit bspw. nur den Wert 100 hat (Der Wert ist abhängig von den verwendeten Widerständen, von der Helligkeit und von der Stromrichtung),
 * dann nimmt man anstelle des Wertes 512 einen wesentlich kleineren Wert, bei dem die LED zu leuchten beginnen soll.
 * Bspw. nimmt man dann den Wert 90. Den aktuellen Sensorwert kann man sich nun mit Hilfe des „Serial monitor“ anzeigen lassen.
 * Dazu klickt man oben auf „Tools“ und anschließend auf „serial monitor“. 
 */
